...
> DataQualityEngine: Data quality validation with rules, scoring, and anomaly detection
...
##  Architecture
Three-tier architecture: Go, Kafka backend, native frontend, PostgreSQL database. Containerized with Docker.
...
git clone https://github.com/elitsuri/dataqualityengine
cd dataqualityengine
